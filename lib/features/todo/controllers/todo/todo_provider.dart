...
class TodoState extends _$TodoState {
  ...
  void updateItem(int id,String title, String desc, int isCompleted,
    ...
    await DbHelper.updateItem(id, title, desc,  isCompleted,
 ...
 void markAsComplete(int id,String title, String desc, int isCompleted,
                                String date,String startTime,String endTime) async{
    await DbHelper.updateItem(id, title, desc,  1,
                                date,startTime,endTime);
    refresh();
  }
